...
namespace Accounts
{
    ...
    public partial class MDIMain : Form
    {
        ...
        Boolean Rights_On_ActiveChild(String Key)
        {
            try
            {
                if (MyBase.Get_RecordCount("Socks_Permission_Master", "User_ID = " + UserCode + " and Menu_Name = '" + this.ActiveMdiChild.AccessibleName + "' and Rights like '%" + Key + "%'") > 0)
                {
                    return true;
                }
                else
        ...
        public void Load_PrintEntry()
        {
            try
            {
                if (this.ActiveMdiChild != null)
                {
                    if (this.ActiveMdiChild.Name == "FrmSalesInvoiceNew" || this.ActiveMdiChild.Name == "FrmCopyQuotation" || this.ActiveMdiChild.Name == "FrmDC" || this.ActiveMdiChild.Name == "FrmInvoice" || this.ActiveMdiChild.Name == "FrmCashsales" || this.ActiveMdiChild.Name == "FrmVoucherEntry" || this.ActiveControl.Name == "FrmSalesEntry" || this.ActiveControl.Name == "FrmSocksYarnPOEntry" || this.ActiveControl.Name == "FrmSocksTrimsPOEntry")
                    {
                        Entry Frm = (Entry)this.ActiveMdiChild;
                        Frm.Entry_Print();
                    }
        ...
        void MenuMaster()
        {
            try
            {
                ...
                if (MyBase.Check_Table("Socks_Menu_Master_New") == false)
                {
                    MyBase.Execute("Create Table Socks_Menu_Master_New (Menu_ID int Identity, Menu_Name varchar(100), Menu_CName varchar(500) unique Not null, Under_Menu_CName varchar(500))");
                }
                MyBase.Execute("Truncate Table Socks_Menu_Master_New");
                Load_MenuItems();
        ...
        public void Company_ChangeOver(int Company_Code, String Year_Code)
        {
            try
            {
                ...
                CompName = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompName");
                CompPrintName = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "InPrinting");
                Progress_Max(20);
                YearCode = Year_Code;
                SDate = MyBase.GetData_InDate("Socks_Companymas", "CompCode", CompCode.ToString(), "Sdt");
                EDate = MyBase.GetData_InDate("Socks_Companymas", "CompCode", CompCode.ToString(), "Edt");
                CompPhone = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompPhone");
                CompFax = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompFax");
                Progress_Max(20);
                CompEmail = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompEmail");
                CompTin = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompTNGSTNo");
                CompCst = MyBase.GetData_InString("Socks_Companymas", "CompCode", CompCode.ToString(), "CompCSTNo");
                Progress_Max(20);
        ...
        void MDICaption()
        {
            ...
            try
            {
                Sql = "SOCKS : " + MyBase.PadR(CompName.ToUpper().Trim() + " ( " + YearCode.Trim() + " )", 77);
                this.Text = Sql + " " + UserName + " - " + MyBase.GetServerDateTime();
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void permissionMasterToolStripMenuItem_Click_2(object sender, EventArgs e)
        {
            try
            {
                if (CompName.ToUpper().Contains("AEGAN"))
                {
                    ShowChild(new FrmPermissionMaster(), Window.Normal, false, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
                }
                else
                {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MyBase.Get_RecordCount("Log_Security_Alert", "Flag = 1 and Module = '" + System.Reflection.Assembly.GetExecutingAssembly().ManifestModule.ScopeName.ToUpper().Replace(".EXE", "") + "'") > 0)
                {
                    Security_Flag = true;
                    Application.Exit();
                }
        ...
        private void invoicingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ShowChild(new FrmGrnInvoicing(), Window.Normal, false, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void orderEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ShowChild(new FrmSocksOrderMaster(), Window.Normal, false, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void planningEntryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ShowChild(new FrmSocksPlanningEntry(), Window.Normal, false, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void budgetApprovalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ShowChild(new FrmBudgetApproval_New(), Window.Normal, true, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void yarnIssueCoveringToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ShowChild(new Frm_Yarn_Indent_Issue_Covering(), Window.Normal, false, false, Entry_Mode._New, Get_Menu_Control_Name((ToolStripMenuItem)sender));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
