...
namespace Accounts
{
    public partial class Frm_Socks_Permission_Master : Form,Entry 
    {
        ...
        public Frm_Socks_Permission_Master()
        {
            InitializeComponent();
        }
...
//             LoadBaseNodes();            // load all the lowest tree nodes
        ...
        {            
            ...
            try
            {
                ...
                Str = "Select Menu_CName Menu_Head_ID, Menu_name Menu_Head, Menu_CName Menu_Head_ID from Socks_Menu_Master_New where under_Menu_CName = 'Main'";
            ...
            try
            {
                ...
                while (intNodeId < treeView1.Nodes.Count)
                {
                   ...
                   // Str = "Select Menu_ID, Menu_Head_ID, Menu_Name , Menu_Text from Menu_Master Where Menu_Head_ID = " + strOld_Menu_Head_ID;
                    ...
                    Str = "Select Menu_CName Menu_ID, under_Menu_CName Menu_Head_ID, Menu_CName Menu_Name, Menu_Name Menu_Text from Socks_Menu_Master_New Where under_Menu_CName = '" + strOld_Menu_Head_ID + "'";
        ...
        private void Frm_Socks_Permission_Master_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Frm_Socks_Permission_Master_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    ...
                    {
                        Dr = Tool.Selection_Tool(this, 150, 150, SelectionTool_Class.ViewType.NormalView, "Select Socks_User_Master", "Select User_Name, User_Code from Socks_User_Master", String.Empty, 150);
                        if (Dr != null)
                        {
                            Txt_UserName.Text = Dr["User_Name"].ToString();
                            Txt_UserName.Tag = Dr["User_Code"].ToString();
                            Fill_Datas(Convert.ToInt16(Txt_UserName.Tag.ToString()));
                        }
                    }
                }
            }
        ...
        public void Entry_Save()
        {
            ...
            try
            {
                ...
                if (Permission_Dt.Rows.Count > 0)
                {
                    ...
                    while (intRowID < Permission_Dt.Rows.Count)
                    {
                        ...
                        if (Permission_Dt.Rows[intRowID]["Permission_ID"].ToString() != "")
                        {
                            ...
                            intPermission_ID = Convert.ToInt16(Permission_Dt.Rows[intRowID]["Permission_ID"].ToString());
                        }
                        ...
                        intUser_ID = Convert.ToInt16(Permission_Dt.Rows[intRowID]["User_ID"].ToString());
                        strRights = Permission_Dt.Rows[intRowID]["Rights"].ToString();

                        if (strRights != "")
                        {
                            Queries[intRowID] = "insert into Socks_Permission_Master values (" + intUser_ID + ", '" + strMenu_Name + "', '" + strRights + "', " + MyParent.UserCode + ", " + MyParent.SysCode + ", " + MyParent.Today + ", " + MyParent.UserCode + ", " + MyParent.SysCode + ", " + MyParent.Today + ", " + MyParent.CompCode + ", '" + MyParent.YearCode + "')";
                            ...
                            //MyBase.SQLCmd.Parameters.Add("@Blocked", System.Data.SqlDbType.VarChar).Value = Convert.ToInt16(Convert.ToBoolean(Chk_Cancel.Checked));
               ...
               MyBase.Run(Queries, "Delete from Socks_Permission_Master where User_ID = " + intUser_ID);
                ///// -------------------------
        ...
        void Fill_Datas(Int32 Identity)
        {
            ...
            try
            {
                ...
                Str += " Pm.Menu_Name,Pm.Rights";
                //Str += " Pm.[Description],Pm.Blocked, Pm.Company_Code";    
                Str += " From Socks_Permission_Master  AS Pm";
                Str += " Left Join Socks_Menu_Master_New As Mn On Pm.Menu_Name = Mn.Menu_CName ";
                Str += " Left Join Socks_User_Master As Um On Pm.[User_ID]  = Um.[user_Code]";
                Str += " Where Pm.[User_ID] = '" + Current_ID + "'";
                Str += " And Pm.Company_Code = '" + MyParent.CompCode + "'";
                // Str += " Order By Menu_Name";
        ...
        public void Entry_Delete_Confirm()
        {
            try
            {
                if (Current_ID > 0)
                {
                    ...
                    MyBase.Execute("Delete from Socks_Permission_Master Where [User_ID] = " + Current_ID);
        ...
        public void Entry_View()
        {
            try
            {
                MyBase.Enable_Controls(this, false);
                MyBase.Clear(this);
                Dr = Tool.Selection_Tool(this, 200, 200, SelectionTool_Class.ViewType.NormalView, "User - View", "Select UserName, User_ID, Description, Blocked from Socks_User_Master", String.Empty, 150);
                if (Dr != null)
                {
                    Fill_Datas(Convert.ToInt32(Dr["User_ID"]));
                }
        ...
        private void Frm_Socks_Permission_Master_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (this.ActiveControl.Name == "Txt_UserName")
