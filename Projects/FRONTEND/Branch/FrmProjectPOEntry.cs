    ...
    public partial class FrmProjectPOEntry : Form, Entry
    {
        ...
        void Fill_Data(DataRow Dr)
        {
            try
            {
                ...
                TxtDelivery.Text = Dr["Delivery_at"].ToString();
                TxtDesp.Text = Dr["Despatch_at"].ToString();
                TxtCred.Text = Dr["Credit_days"].ToString();
                Dtpdel.Value = Convert.ToDateTime(Dr["DAte_of_delivery"]);
                if (Dr["Payment_Mode"].ToString().Contains("CASH"))
                {
                    cash.Checked = true;
                }
                else if (Dr["Payment_Mode"].ToString().Contains("CHEQUE"))
                {
                    cheque.Checked = true;
                }
                else
                {
                    Txtothers.Text = Dr["Payment_Mode"].ToString();
        ...
        public void Entry_Save()
        {
            ...
            try
            {
                ...
                if (Dts.Rows.Count > 0)
                {
                    ...
                    if (txtExrate.Text.Trim() == String.Empty || Convert.ToDouble(txtExrate.Text) == 0)
                    {
        ...
        public void Entry_View()
        {
            try
            {
                ...
                MyBase.Clear(this);
                lblMail.Text = "";
                Dr = Tool.Selection_Tool_Resize(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select PO Details - View", "select PoNo, Supplier, PoDate, Indent_NO, Indent_Date, Proj_Type, Proj_ACtivity_NAme, Order_No, PArty, Item, Color, Size, Uom1, Order_Qty_Conv Order_Qty, Cancel_Qty_Conv Cancel_Qty, Grs_Rate_Conv Grs_Rate, Tax_Per, Freight_Rate_Conv Freight_Rate, Rate_Conv Pur_Rate, Grs_Amount_Dtl, Tax_Amount_Dtl, Freight_Amount_Dtl, Pur_Amount, Approval_Flag_PO First_Approval, Approval_Flag_PO1 Second_Approval, REquired_Date, Ack_Date, Commit_Date, MailId, Tot_Grs_Amount, Tot_Tax_Amount, Tot_Freight_Amount, Tot_Net_Amount,  Remarks_Mas , Supplier_Code, Buyer_Code, Country_Code, Rowid, Detail_ID,Delivery_at,Despatch_at,Credit_days,isnull(DAte_of_delivery,Getdate()) DAte_of_delivery ,Payment_Mode, Ex_Rate  From Project_PO_Details_Fn() where Company_Code = " + MyParent.CompCode + "  ORder by 1 desc ", String.Empty, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100);
                if (Dr != null)
                {
                    Fill_Data(Dr);
                }
        ...
        public void Entry_Print()
        {
            try
            {
                ...
                Str = "Select Rowid, PoNo, PoDate, Indent_NO, convert(varchar,Cast(Indent_Date as Date),105) Indent_Date, Supplier, Supplier_COde, REquired_Date, Approval_Flag_PO, Ack_Date, Commit_Date, MailId, Tot_Grs_Amount, Tot_Tax_Amount, Tot_Freight_Amount, Tot_Net_Amount, Approval_Time_PO, Approval_System_PO, Remarks_Mas, PrintOutDate, Address, LedgeR_Phone, Order_Qty, Pur_Rate, Cancel_Qty, Grs_Rate, Tax_Per, Freight_Rate, Grs_Amount_Dtl, Tax_Amount_Dtl, Freight_Amount_Dtl, Pur_Amount, Item, Color, Size, Rate, Description, Conv_Val, Country_Code, Uom1, Delivery_at, Despatch_at, Credit_days, DAte_of_delivery, Payment_Mode, Igst, Sgst, Cgst, Tcs , Gst_No, Currency  From Project_Po_Print_Fn(" + Code + ")";
                MyBase.Execute_Qry(Str, "Project_Material_PO");

                Str2 = "Select Rowid, PoNo, PoDate, Indent_NO, Supplier, Supplier_COde, OrdeR_No + '-' + Proj_ACtivity_Name OrdeR_No, Party, Sum(Order_Qty_Conv) Order_Qty, Rate_Conv Pur_Rate, Sum(Cancel_Qty_Conv) Cancel_Qty, Grs_Rate_Conv Grs_Rate, Tax_Per, Freight_Rate_Conv Freight_Rate, Sum(Grs_Amount_Dtl) Grs_Amount_Dtl, Sum(Tax_Amount_Dtl) Tax_Amount_Dtl, Sum(Freight_Amount_Dtl) Freight_Amount_Dtl, Sum(Pur_Amount) Pur_Amount,  Item, Color, Size, Rate_Conv Rate, Delivery_at, Despatch_at, Credit_days, DAte_of_delivery, Payment_Mode from Project_PO_Details_Fn() Where RowID = " + Code + " Group by Rowid, PoNo, PoDate, Indent_NO, Supplier, Supplier_COde, Pur_Rate, Grs_Rate_Conv, Tax_Per, Freight_Rate_Conv, Item, Color, Size, Rate_Conv, ORder_No, PArty, Proj_ACtivity_NAme, Delivery_at, Despatch_at, Credit_days, DAte_of_delivery, Payment_Mode ";
                ...
                {
                    Comp_Print = "IRULAPPA MILLS INDIA P LTD";

                    if (MyParent.Proj_Login_Name == "MACHINERY" || 1==1)
                    {
                        ObjRpt.Load(System.Windows.Forms.Application.StartupPath + "\\RptPurchasePO_Mac_Irul.rpt");
                    }
                    else
                    {
                        ObjRpt.Load(System.Windows.Forms.Application.StartupPath + "\\RptPurchasePO_Irul.rpt");
                    }
                }
                else if (MyParent.CompCode == 8)
                {
                    Comp_Print = "GAINUP TECHNOTEK LIMITED";

                    if (MyParent.Proj_Login_Name == "MACHINERY" || 1 == 1)
                    {
                        
                        ObjRpt.Load(System.Windows.Forms.Application.StartupPath + "\\RptPurchasePO_Tech_Mac.rpt");
                    }
                    else
                    {
                       
                            ObjRpt.Load(System.Windows.Forms.Application.StartupPath + "\\RptPurchasePO_tech.rpt");
                       
                    }
                }
                else
                {
                    Comp_Print = "GAINUP INDUSTRIES INDIA P LTD";
                ...
                MyParent.FormulaFill(ref ObjRpt, "Company", Comp_Print.ToString());
               // MyParent.FormulaFill(ref ObjRpt, "CompanyP", Comp_Print.ToString());
                MyParent.FormulaFill(ref ObjRpt, "Heading", "MATERIAL PO ");
                
                if (Res == DialogResult.Yes)
                {
                    MyParent.CReport(ref ObjRpt, "MATERIAL PO..!");
            ...
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    if (this.ActiveControl.Name == "TxtBuyer")
                    {
                        ...
                        ////{
                        ////    Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Buyer", "Select Ledger_Name Buyer, LEdger_Code Code  From  Buyer_all_Fn() where LedgeR_Code = 7364 ", String.Empty, 600);
                        ////}
                        
                        //if (MyParent.CompCode == 3)
                        //{
                        //    Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Buyer", "Select Ledger_Name Buyer, LEdger_Code Code  From  Buyer_all_Fn() where LedgeR_Code = 7392 ", String.Empty, 600);

                        //}
                        //else 
                        //{
                        Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Buyer", "Select Ledger_Name Buyer, LEdger_Code Code  From  Buyer_all_Fn() where LEdger_Code = " + MyParent.Proj_Login_Code + " ", String.Empty, 600);
                    ...
                    else if (this.ActiveControl.Name == "TxtSupplier")
                    {
                        ...
                        //if (MyParent.CompCode == 1 || MyParent.CompCode == 8)
                        //{
                        //    Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Supplier", "Select  LedgeR_Name Supplier, LedgeR_Email, LedgeR_Code Code, Country_COde, 0 Old_ID From Supplier_all_Fn_Co(1) Union Select  LedgeR_Name Supplier, LedgeR_Email, LedgeR_Code Code, Country_COde, 0 Old_ID From Supplier_all_Fn_Co(8) where LedgeR_NAme not in (Select  LedgeR_Name From Supplier_all_Fn_Co(1))  ", String.Empty, 250, 200);                        
                        //}
                        //else
                       // {
                            Dr = Tool.Selection_Tool(this, 30, 70, SelectionTool_Class.ViewType.NormalView, "Select Supplier", "Select LedgeR_Name Supplier, LedgeR_Email, LedgeR_Code Code, Country_COde, 0 Old_ID From Supplier_all_Fn_Co(" + MyParent.CompCode + ") ", String.Empty, 250, 200);
                        //}
                        if (Dr != null)
                            {
                                ctycode = Convert.ToInt64(Dr["Country_COde"]);
                                DataTable Dts = new DataTable();
                                String St1 = "Select * From ACCOUNTS.dbo.Blocked_Ledgers_List(" + MyParent.CompCode + ") Where Ledger_Code= " + Dr["Code"].ToString() + "";
                                MyBase.Load_Data(St1, ref Dts);
                                if (Dts.Rows.Count > 0)
                                {
                                    MessageBox.Show("This Supplier Has Been Blocked By Accounts...!");
        ...
        void Load_Item()
        {
            try
            {
                ...
                MyBase.Grid_Designing(ref Grid_Item, ref Dt_Item, "Order_ID", "PRoj_Type_ID", "Calc_Type", "Proj_Activity_ID", "UOM1", "CONV_VAL", "ITEM_ID", "COLOR_ID", "SIZE_ID", "UOMID1", "Bom_Org", "Ordered_Org", "Bal_Org", "PO_Qty_Org", "App_Grs_Org", "App_Tax_Org", "App_Frei_Org", "App_Pur_Rate_Org", "PO_Qty_Org_Conv", "App_Grs_Org_Conv", "App_Frei_Org_Conv", "App_Pur_Rate_Org_Conv", "PO_Qty_Conv", "Grs_Rate_Conv", "Tax_Rate_Conv", "Frei_Rate_Conv", "Pur_Rate_Conv", "App_Sup_Ex_Rate", "GRS_AMT_INR", "TAX_AMT_INR", "FREI_AMT_INR", "PUR_AMT_INR", "RNO", "DESC2", "UOMID", "UOMID1", "ORDER_ID", "DESCRIPTION", "REMARKS", "APP_TAX", "APP_FREI", "APP_PUR_RATE");
                 ...
                 MyBase.ReadOnly_Grid_Without(ref Grid_Item, "ORDER_NO", "GRS_RATE", "TAX_PER", "FREIGHT_RATE", "PO_QTY", "UOM1", "RO_AMT", "FREI_TAX_MODE", "RO_RATE", "DESCRIPTION1");
                MyBase.Grid_Colouring(ref Grid_Item, Control_Modules.Grid_Design_Mode.Column_Wise);
                MyBase.Grid_Width(ref Grid_Item, 40, 120, 120, 150, 120, 100, 100, 100, 100, 100, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80, 80);
                ...
                Grid_Item.Columns["DESCRIPTION1"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void FrmProjectPOEntry_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (this.ActiveControl is TextBox)
                {
                    if (this.ActiveControl.Name != String.Empty && this.ActiveControl.Name != "TxtIndent" && this.ActiveControl.Name != "TxtDelivery" && this.ActiveControl.Name != "TxtDesp" && this.ActiveControl.Name != "TxtCred" && this.ActiveControl.Name != "TxtRemarks")
                    {
                        e.Handled = true;
                    }
                    if (this.ActiveControl.Name == "Txtothers")
                    {
                        e.Handled = false;
                        cash.Checked = false;
                        cheque.Checked = false;    
                    }
                    if (this.ActiveControl.Name == "cash" || this.ActiveControl.Name == "cheque")
                    {
                        Txtothers.Text = "";
                    }
                    if (cash.Checked || cheque.Checked == true)
                    {
                        Txtothers.Clear();
                    }
                    if (this.ActiveControl.Name == txtExrate.Name)
                    {
                        MyBase.Valid_Decimal((TextBox)txtExrate, e);
                    }
                }
            }
            catch (Exception ex)
        ...
        void Txt_Item_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                else if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["DESCRIPTION1"].Index)
                {
                    e.Handled = false;
                }
                else
                    ...
                    if (Grid_Item.CurrentCell.ColumnIndex == Grid_Item.Columns["ORDER_NO"].Index)
                    {
                        ...
                        if (lblMail.Tag.ToString() == "1")
                        {
                            ...
                            else
                            {
                                if (ChkSize1.Checked == false)
                                {
                                    if (MyParent.CompCode == 1 || MyParent.CompCode == 8 && MyParent.CompName != "GAINUP TECHNOTEK LIMITED - SUBBULAPURAM")
                                    {
                                        Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo,'/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom  ProjectPO_Pending_Items_All_Grid_View  Where company_Code in (1,8) and Party_Code = " + TxtBuyer.Tag + "  and Item Not like '%Man%days%' ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                                    }
                                    else if (MyParent.CompName == "GAINUP TECHNOTEK LIMITED - SUBBULAPURAM")
                                    {
                                        Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo,'/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom  ProjectPO_Pending_Items_All_Grid_View  Where company_Code in (10) and Party_Code = " + TxtBuyer.Tag + "  and Item Not like '%Man%days%' ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                                    }
                                    else
                                    {
                                        Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo,'/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom  ProjectPO_Pending_Items_All_Grid_View  Where company_Code = " + MyParent.CompCode + " and Party_Code = " + TxtBuyer.Tag + "  and Item Not like '%Man%days%' ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                                    }
                                }
                                else
                                {
                                    Dr = Tool.Selection_Tool_Except_New_Resize("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO, Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo,'/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom  ProjectPO_Pending_Items_All_Grid_View  Where company_Code = " + MyParent.CompCode + " and Party_Code = " + TxtBuyer.Tag + " ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                                }
                            }
                        }
                        else
                        {
                            ...
                            {
                                Dr = Tool.Selection_Tool_Except_New("Description", this, 30, 70, ref Dt_Item, SelectionTool_Class.ViewType.NormalView, "Select Item", "sElect OrdeR_NO,  Proj_Activity_Name, Proj_Type , ITEM, COLOR, SIZE, RNo, UOM, BOM, ORDERED, PO_QTY, GRS_RATE, TAX_PER, FREIGHT_RATE, PUR_RATE, 0.0000 RO_RATE, GRS_AMT, TAX_AMT, FREI_AMT, PUR_AMT, UOMID, ITEM_ID, COLOR_ID, SIZE_ID,  DESCRIPTION, UOM1, UOMID1, 1.000 CONV_VAL, 0.000 BOM_ORG, 0.000 ORDERED_ORG, 0.000 BAL_ORG, 0.000 PO_QTY_ORG, APP_GRS_ORG, 0.0 APP_TAX_ORG, APP_FREI_ORG, APP_PUR_RATE_ORG, 0.000 PO_QTY_ORG_CONV, 0.0000 APP_GRS_ORG_CONV, 0.0000 APP_FREI_ORG_CONV, 0.0000 APP_PUR_RATE_ORG_CONV, 0.000 BAL, 0.0000 APP_GRS, 0.0 APP_TAX, 0.0000 APP_FREI, 0.0000 APP_PUR_RATE, 0.0000 TAX_RATE, TAX_MODE, 0.00 RO_AMT, 0.000 PO_QTY_CONV, 0.0000 GRS_RATE_CONV, 0.0000 TAX_RATE_CONV, 0.0000 FREI_RATE_CONV, 0.0000 PUR_RATE_CONV, 0.00 GRS_AMT_INR, 0.00 TAX_AMT_INR, 0.00 FREI_AMT_INR, 0.00 PUR_AMT_INR, App_Sup_Ex_Rate, RNo, '/' CALC_TYPE, DESC2, Proj_Activity_ID, Proj_Type_ID, ORder_ID, '-' REMARKS  FRom ProjectPO_Pending_Items_All_Grid_View_Fc  Where company_Code = " + MyParent.CompCode + " and Party_Code = " + TxtBuyer.Tag + " ORder by OrdeR_NO, Rno, Proj_Type , Proj_Activity_Name ", String.Empty, 120, 150, 100, 100, 100, 100, 80, 80, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 80);
                        ...
                        else
                        {
                            ...
                            if (lblMail.Tag.ToString() == "1")
                            {
                                if (TxtBuyer.Text.Trim() == String.Empty)
                                {
                                    MyBase.Load_Data("SELECT 0 SL, OrdeR_NO, Proj_Type, Proj_Activity_Name, ITEM, COLOR, SIZE, UOM, UOM UOM1, CONV_VAL, BOM BOM_ORG, ORDERED ORDERED_ORG, PO_QTY BAL_ORG, PO_QTY PO_QTY_ORG, GRS_RATE APP_GRS_ORG, TAX_PER APP_TAX_ORG, FREIGHT_RATE APP_FREI_ORG,  PUR_RATE APP_PUR_RATE_ORG,  PO_QTY PO_QTY_ORG_CONV, GRS_RATE APP_GRS_ORG_CONV, FREIGHT_RATE APP_FREI_ORG_CONV, PUR_RATE APP_PUR_RATE_ORG_CONV,  BOM, ORDERED, PO_QTY BAL, PO_QTY PO_QTY, GRS_RATE APP_GRS, TAX_PER APP_TAX, FREIGHT_RATE APP_FREI, PUR_RATE APP_PUR_RATE,  GRS_RATE, TAX_PER,  TAX_RATE,  FREIGHT_RATE, 'B' FREI_TAX_MODE,  RO_RATE,  PUR_RATE,  GRS_AMT, TAX_AMT,   FREI_AMT, RO_AMT, PUR_AMT, PO_QTY PO_QTY_CONV, GRS_RATE GRS_RATE_CONV,  TAX_RATE_CONV TAX_RATE_CONV, FREIGHT_RATE FREI_RATE_CONV,PUR_RATE PUR_RATE_CONV,  GRS_AMT GRS_AMT_INR, TAX_AMT TAX_AMT_INR, FREI_AMT FREI_AMT_INR, PUR_AMT PUR_AMT_INR, App_Sup_Ex_Rate, Order_ID, PRoj_Type_ID, Proj_Activity_ID,  DESCRIPTION ,   UOMID, ITEM_ID, COLOR_ID, SIZE_ID, UOMID1, '/' CALC_TYPE, RNO, DESC2, REMARKS  FROM    ProjectPO_Pending_Items_All_Grid_View  Where company_Code = " + MyParent.CompCode + " and PROJ_TYPE_ID = " + Dr["PROJ_TYPE_ID"].ToString() + " and ITem_Id = " + Dr["ITEM_ID"].ToString() + "  and SizE_ID = " + Dr["SIZE_ID"].ToString() + " ORder by RNo ", ref TDtT1);
                                }
                                else
                                {
                                    if (MyParent.CompName == "GAINUP TECHNOTEK LIMITED - SUBBULAPURAM")
                                    {
                                        MyBase.Load_Data("SELECT 0 SL, OrdeR_NO, Proj_Type, Proj_Activity_Name, ITEM, COLOR, SIZE, UOM, UOM UOM1, CONV_VAL, BOM BOM_ORG, ORDERED ORDERED_ORG, PO_QTY BAL_ORG, PO_QTY PO_QTY_ORG, GRS_RATE APP_GRS_ORG, TAX_PER APP_TAX_ORG, FREIGHT_RATE APP_FREI_ORG,  PUR_RATE APP_PUR_RATE_ORG,  PO_QTY PO_QTY_ORG_CONV, GRS_RATE APP_GRS_ORG_CONV, FREIGHT_RATE APP_FREI_ORG_CONV, PUR_RATE APP_PUR_RATE_ORG_CONV,  BOM, ORDERED, PO_QTY BAL, PO_QTY PO_QTY, GRS_RATE APP_GRS, TAX_PER APP_TAX, FREIGHT_RATE APP_FREI, PUR_RATE APP_PUR_RATE,  GRS_RATE, TAX_PER,  TAX_RATE,  FREIGHT_RATE, 'B' FREI_TAX_MODE,  RO_RATE,  PUR_RATE,  GRS_AMT, TAX_AMT,   FREI_AMT, RO_AMT, PUR_AMT, PO_QTY PO_QTY_CONV, GRS_RATE GRS_RATE_CONV,  TAX_RATE_CONV TAX_RATE_CONV, FREIGHT_RATE FREI_RATE_CONV,PUR_RATE PUR_RATE_CONV,  GRS_AMT GRS_AMT_INR, TAX_AMT TAX_AMT_INR, FREI_AMT FREI_AMT_INR, PUR_AMT PUR_AMT_INR, App_Sup_Ex_Rate, Order_ID, PRoj_Type_ID, Proj_Activity_ID,  DESCRIPTION ,   UOMID, ITEM_ID, COLOR_ID, SIZE_ID, UOMID1, '/' CALC_TYPE, RNO, DESC2, REMARKS FROM    ProjectPO_Pending_Items_All_Grid_View  Where  company_Code = 10 and Party_Code = " + TxtBuyer.Tag + " and PROJ_TYPE_ID = " + Dr["PROJ_TYPE_ID"].ToString() + "  and ITem_Id = " + Dr["ITEM_ID"].ToString() + "  and SizE_ID = " + Dr["SIZE_ID"].ToString() + " ORder by RNo ", ref TDtT1);
                                    }
                                    else
                                    {
                                        MyBase.Load_Data("SELECT 0 SL, OrdeR_NO, Proj_Type, Proj_Activity_Name, ITEM, COLOR, SIZE, UOM, UOM UOM1, CONV_VAL, BOM BOM_ORG, ORDERED ORDERED_ORG, PO_QTY BAL_ORG, PO_QTY PO_QTY_ORG, GRS_RATE APP_GRS_ORG, TAX_PER APP_TAX_ORG, FREIGHT_RATE APP_FREI_ORG,  PUR_RATE APP_PUR_RATE_ORG,  PO_QTY PO_QTY_ORG_CONV, GRS_RATE APP_GRS_ORG_CONV, FREIGHT_RATE APP_FREI_ORG_CONV, PUR_RATE APP_PUR_RATE_ORG_CONV,  BOM, ORDERED, PO_QTY BAL, PO_QTY PO_QTY, GRS_RATE APP_GRS, TAX_PER APP_TAX, FREIGHT_RATE APP_FREI, PUR_RATE APP_PUR_RATE,  GRS_RATE, TAX_PER,  TAX_RATE,  FREIGHT_RATE, 'B' FREI_TAX_MODE,  RO_RATE,  PUR_RATE,  GRS_AMT, TAX_AMT,   FREI_AMT, RO_AMT, PUR_AMT, PO_QTY PO_QTY_CONV, GRS_RATE GRS_RATE_CONV,  TAX_RATE_CONV TAX_RATE_CONV, FREIGHT_RATE FREI_RATE_CONV,PUR_RATE PUR_RATE_CONV,  GRS_AMT GRS_AMT_INR, TAX_AMT TAX_AMT_INR, FREI_AMT FREI_AMT_INR, PUR_AMT PUR_AMT_INR, App_Sup_Ex_Rate, Order_ID, PRoj_Type_ID, Proj_Activity_ID,  DESCRIPTION ,   UOMID, ITEM_ID, COLOR_ID, SIZE_ID, UOMID1, '/' CALC_TYPE, RNO, DESC2, REMARKS FROM    ProjectPO_Pending_Items_All_Grid_View  Where  company_Code = " + MyParent.CompCode + " and Party_Code = " + TxtBuyer.Tag + " and PROJ_TYPE_ID = " + Dr["PROJ_TYPE_ID"].ToString() + "  and ITem_Id = " + Dr["ITEM_ID"].ToString() + "  and SizE_ID = " + Dr["SIZE_ID"].ToString() + " ORder by RNo ", ref TDtT1);
                                    }
                                }
                            }
                            else
                            {
                                MyBase.Load_Data("SELECT 0 SL, OrdeR_NO, Proj_Type, Proj_Activity_Name, ITEM, COLOR, SIZE, UOM, UOM UOM1, CONV_VAL, BOM BOM_ORG, ORDERED ORDERED_ORG, PO_QTY BAL_ORG, PO_QTY PO_QTY_ORG, GRS_RATE APP_GRS_ORG, TAX_PER APP_TAX_ORG, FREIGHT_RATE APP_FREI_ORG,  PUR_RATE APP_PUR_RATE_ORG,  PO_QTY PO_QTY_ORG_CONV, GRS_RATE APP_GRS_ORG_CONV, FREIGHT_RATE APP_FREI_ORG_CONV, PUR_RATE APP_PUR_RATE_ORG_CONV,  BOM, ORDERED, PO_QTY BAL, PO_QTY PO_QTY, GRS_RATE APP_GRS, TAX_PER APP_TAX, FREIGHT_RATE APP_FREI, PUR_RATE APP_PUR_RATE,  GRS_RATE, TAX_PER,  TAX_RATE,  FREIGHT_RATE, 'B' FREI_TAX_MODE,  RO_RATE,  PUR_RATE,  GRS_AMT, TAX_AMT,   FREI_AMT, RO_AMT, PUR_AMT, PO_QTY PO_QTY_CONV, GRS_RATE GRS_RATE_CONV,  TAX_RATE_CONV TAX_RATE_CONV, FREIGHT_RATE FREI_RATE_CONV,PUR_RATE PUR_RATE_CONV,  GRS_AMT GRS_AMT_INR, TAX_AMT TAX_AMT_INR, FREI_AMT FREI_AMT_INR, PUR_AMT PUR_AMT_INR, App_Sup_Ex_Rate, Order_ID, PRoj_Type_ID, Proj_Activity_ID,  DESCRIPTION ,   UOMID, ITEM_ID, COLOR_ID, SIZE_ID, UOMID1, '/' CALC_TYPE, RNO, DESC2, REMARKS  FROM    ProjectPO_Pending_Items_All_Grid_View_Fc  Where company_Code = " + MyParent.CompCode + " and PROJ_TYPE_ID = " + Dr["PROJ_TYPE_ID"].ToString() + " and ITem_Id = " + Dr["ITEM_ID"].ToString() + "  and SizE_ID = " + Dr["SIZE_ID"].ToString() + " ORder by RNo ", ref TDtT1);
                            }
        ...
        private void ChkSize1_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void myTextBox3_TextChanged_1(object sender, EventArgs e)
        {
            //if(ActiveControl.Name=="cash")
            //{
        ...
        {
            if ( this.ActiveControl.Name == "cheque")
            {
                Txtothers.Text = "";
            }
        }
