...
namespace Accounts_ControlModules
{
    class Control_Modules
    {
        ...
        public void Valid_T_OR_F(System.Windows.Forms.TextBox txt, System.Windows.Forms.KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == Convert.ToInt32('T') || e.KeyChar == Convert.ToInt32('t'))
                {
                    e.Handled = true;
                    txt.Text = "T";
                }
        ...
        public void Valid_M_OR_A(System.Windows.Forms.TextBox txt, System.Windows.Forms.KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == Convert.ToInt32('M') || e.KeyChar == Convert.ToInt32('m'))
                {
                    e.Handled = true;
                    txt.Text = "M";
                }
                else if (e.KeyChar == Convert.ToInt32('A') || e.KeyChar == Convert.ToInt32('a'))
                {
                    e.Handled = true;
                    txt.Text = "A";
                }
        ...
        public Boolean SendFromGmail(String FromID, String ToId, String CCID, String Subject, String Body, Boolean IsHtmlBody, String Password, params String[] AttachmentFilePath)
        {
            try
            {
